...
The package adds exactly one server endpoint, `POST /umbraco/member-dashboard/api/v1/bulk`, because
bulk operations genuinely need one:
...
src/Umbraco.Community.MemberDashboard/   The package (Razor Class Library + TypeScript client)
  ...
  Controllers/ Services/ ViewModels/     The bulk endpoint
